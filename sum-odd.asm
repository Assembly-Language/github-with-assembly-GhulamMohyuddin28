...
sumMsg byte "Sum of Odd Numbers is: ",0                   ;Message to display the sum
CountMsg byte "Total number of Odd numbers are: ",0       ;Message to display the total number
...
Next:                                                     ;Label named Next
    ...
    jz skip                                               ;Skip if the number is even

    add ax, dx                                            ;Adding the odd number to the sum
    inc ebx                                               ;Incrementing EBX to count the odd number
...
call writestring
mov eax, ebx                                              ;Moving the count of odd numbers into EAX
call writedec
